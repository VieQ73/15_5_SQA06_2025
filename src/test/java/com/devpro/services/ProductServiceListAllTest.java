...
public class ProductServiceListAllTest {
    ...
    public void testListAll_KeywordIsNull() {
        logger.info("Bắt đầu testListAll_KeywordIsNull: Kiểm tra listAll với keyword là null.");
        // Chuẩn bị dữ liệu
        String keyword = null;
        ...
        logger.info("Hoàn thành testListAll_KeywordIsNull.");
    }

    // Test case 2: keyword là chuỗi rỗng
    @Test
    public void testListAll_KeywordIsEmpty() {
        logger.info("Bắt đầu testListAll_KeywordIsEmpty: Kiểm tra listAll với keyword là chuỗi rỗng.");
        // Chuẩn bị dữ liệu
        String keyword = "";
        List<Product> mockProducts = new ArrayList<>();
        Product product1 = new Product();
        ...
        verify(entityManager, never()).createNativeQuery(anyString(), eq(Product.class));
        assertEquals(mockProducts, result, "Danh sách trả về phải giống mockProducts");
        logger.info("Hoàn thành testListAll_KeywordIsEmpty.");
    }

    // Test case 3: keyword là chuỗi hợp lệ, có sản phẩm khớp
    @Test
    public void testListAll_KeywordValidWithMatchingProducts() {
        logger.info("Bắt đầu testListAll_KeywordValidWithMatchingProducts: Kiểm tra listAll với keyword hợp lệ và có sản phẩm khớp.");
        // Chuẩn bị dữ liệu
        ...
        assertEquals(mockProducts, result, "Danh sách trả về phải giống mockProducts");
        logger.info("Hoàn thành testListAll_KeywordValidWithMatchingProducts.");
    }

    // Test case 4: keyword chứa ký tự đặc biệt
    @Test
    public void testListAll_KeywordWithSpecialCharacters() {
        logger.info("Bắt đầu testListAll_KeywordWithSpecialCharacters: Kiểm tra listAll với keyword chứa ký tự đặc biệt.");
        // Chuẩn bị dữ liệu
        String keyword = "phone%";
        List<Product> mockProducts = new ArrayList<>();
        Product product1 = new Product();
        ...
        verify(productRepo, never()).findAll();
        assertEquals(mockProducts, result, "Danh sách trả về phải giống mockProducts");
        logger.info("Hoàn thành testListAll_KeywordWithSpecialCharacters.");
    }

    // Test case 5: keyword không khớp với sản phẩm nào
    @Test
    public void testListAll_KeywordNoMatchingProducts() {
        logger.info("Bắt đầu testListAll_KeywordNoMatchingProducts: Kiểm tra listAll với keyword không khớp với sản phẩm nào.");
        // Chuẩn bị dữ liệu
        String keyword = "xyz";
        List<Product> mockProducts = new ArrayList<>();
        ...
        logger.info("Hoàn thành testListAll_KeywordNoMatchingProducts.");
    }

    // Test case 6: keyword khớp với nhiều sản phẩm
    @Test
    public void testListAll_KeywordWithMultipleMatchingProducts() {
        logger.info("Bắt đầu testListAll_KeywordWithMultipleMatchingProducts: Kiểm tra listAll với keyword khớp với nhiều sản phẩm.");
        // Chuẩn bị dữ liệu
        String keyword = "phone";
        List<Product> mockProducts = new ArrayList<>();
        Product product1 = new Product();
        ...
        assertEquals(mockProducts, result, "Danh sách trả về phải giống mockProducts");
        logger.info("Hoàn thành testListAll_KeywordWithMultipleMatchingProducts.");
    }

    // Test case 7: productRepo.findAll() trả về danh sách rỗng
    @Test
    public void testListAll_KeywordIsNullWithEmptyProductRepo() {
        logger.info("Bắt đầu testListAll_KeywordIsNullWithEmptyProductRepo: Kiểm tra listAll với keyword là null và productRepo rỗng.");
        // Chuẩn bị dữ liệu
        String keyword = null;
        List<Product> mockProducts = new ArrayList<>();
        when(productRepo.findAll()).thenReturn(mockProducts);
        ...
        verify(entityManager, never()).createNativeQuery(anyString(), eq(Product.class));
        assertTrue(result.isEmpty(), "Danh sách trả về phải rỗng");
        logger.info("Hoàn thành testListAll_KeywordIsNullWithEmptyProductRepo.");
    }

    // Test case 8: productRepo.findAll() ném ngoại lệ
    @Test
    public void testListAll_KeywordIsNullWithProductRepoException() {
        logger.info("Bắt đầu testListAll_KeywordIsNullWithProductRepoException: Kiểm tra listAll với keyword là null và productRepo ném ngoại lệ.");
        // Chuẩn bị dữ liệu
        String keyword = null;
        ...
        verify(productRepo, times(1)).findAll();
        verify(entityManager, never()).createNativeQuery(anyString(), eq(Product.class));
        logger.info("Hoàn thành testListAll_KeywordIsNullWithProductRepoException.");
    }
}