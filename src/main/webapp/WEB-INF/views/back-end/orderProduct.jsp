								...
								<tr>
									...
									<td>
										...
										<c:if test="${order.status == 1}">
											...
											<button class="btn btn-primary" id="cmd">Xuất hóa đơn</button>
										</c:if>
									</td>
								</tr>
		            ...
		            <div class="col-md-12">
		                <div class="card" id="invoice" style="max-width: 794px; padding: 2rem;">
		                    ...
		                    <div class="container row">
		                    	...
		                    	<br>
		                    	<h4 id="ntn" style="font-style: italic; margin-left: 25rem;"></h4>
		                    	<h4 style="font-style: italic; margin-left: 25rem;">Số: ${order.id}</h4>
		                    </div>
		                    <br>
		                    <div class="card-body">
		                        <div class="row">
