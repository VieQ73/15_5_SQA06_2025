...
<body>
	...
	<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" method="POST" action="/registration" modelAttribute="account">
				...
				<div class="wrap-input100 validate-input " style="margin-top:15px;" data-validate="Enter your email">
					<input class="input100 form-control" type="email" name="email" placeholder="email">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input " style="margin-top:15px;" data-validate="Enter username">
				...
				<div class="wrap-input100 validate-input" style="margin-top:15px;" data-validate = "Confirm password">
					<input class="input100 form-control" type="password" name="confirm password" placeholder="Confirm password">
					<span class="focus-input100"></span>
				</div>
				
				<div class="container-login100-form-btn " style="margin-top:25px; margin-bottom: 30px;">
				...
				<div class="text-center">
					<a href="${pageContext.request.contextPath}/cai-nay-la-mapping-trong-adminlogincontroller" class="txt2 hov1">
						You have an account
					</a>
				</div>
			</form>
